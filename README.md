...
1. 각 차수 별 실행 결과
2. 우승자 안내 문구 (단독 or 공동)
3. 에러 상황 시 에러 문구

- [x] 자동차 이름 입력받아 쉼표를 기준으로 구분
- [x] 예외) 자동차의 개수가 2대 미만인 경우
- [x] 예외) 6자 이상의 이름이 입력된 경우

- [x] 시도할 회수 입력
- [x] 예외) 숫자가 아닌 경우
- [x] 예외) int 범위를 초과한 경우

- [x] 전체 `Cars`를 관리하는 객체 생성
- [x] 0에서 9 사이의 무작위 값을 구함
- [x] 무작위 값이 4 이상인 차에 대해 전진시킴
- [x] 각 차수 별 실행 결과 출력

- [x] 시도 횟수만큼 진행한 후 게임 종료
- [x] 가장 멀리 이동한 자동차를 우승자로 선정
- [x] 우승자 안내 문구 출력
